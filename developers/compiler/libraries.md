...
| NFT.write(from:Address, symbol:String, tokenID:Number, ram:Any)                                         | None        | Updates NFT RAM through `Runtime.WriteToken`; `tokenID` is the runtime-visible Phantasma NFT ID. |
...
| Method                                                                                                                           | Return type | Description                                                                                                                                                                          |
| -------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Token.create(from:Address, script:Bytes, abi:Bytes) | None | Method used to create a new token; the symbol, name, supply, decimals, and flags come from the token module. NFTs are also created with this method. |
...
| Token.write(from:Address, symbol:String, tokenID:Number, ram:Any)                                                                | None        | Updates NFT RAM through `Runtime.WriteToken`; `tokenID` is the runtime-visible Phantasma NFT ID.                                                                                     |
